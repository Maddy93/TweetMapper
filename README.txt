Introduction
This has been done in Python on Django framework.
Software used
1. Python
2. Django
...
7. The heat-map has a toggle button which can be used to switch the views between positive twets and negative tweets
